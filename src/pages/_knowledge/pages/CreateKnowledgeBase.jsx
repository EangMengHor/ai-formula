  ...
  async function onTemplateFormSubmit(values) {
    ...
    try {
      ...
      createPersonaForm.setValue(
        "maxPersonas",
        response.data[0].output.maxPersonas,
      );
    ...
    <div className="container  mx-auto py-10">
      <Card className="border-2">
        <CardHeader>
          ...
          <CardDescription>
            Configure your AI persona with specific traits and behaviors. Fill
            out the form below to create a new superior persona to auto fill
            below form.
          </CardDescription>
        </CardHeader>
        ...
        <CardContent className="mt-10">
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <Button
                          type="submit"
                          onClick={createTemplateForm.handleSubmit(
                            onTemplateFormSubmit,
                          )}
                          className="w-full sm:w-auto"
                        >
                          {isTemplateSuccess && !isTemplateLoading
                            ? "Auto Fill Successful"
                            : isTemplateLoading
                              ? "Loading..."
                              : "Auto Fill Superior Persona"}
                          <Sparkles className="w-4 h-4 " />
                        </Button>
                      </FormItem>
                    )}
          ...
          <Form {...createPersonaForm}>
            <form
              onSubmit={createPersonaForm.handleSubmit(onSubmit)}
              className="space-y-6"
            >
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>
                      Give your persona a unique and descriptive title.
                    </FormDescription>
                    <FormControl>
                      <Input
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>
                      Describe the persona's behavior, knowledge, task and
                      Output formats and details about each persona style.
                    </FormDescription>
                    <FormControl>
                      <Textarea
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>
                      Set the maximum number of instances for this persona.
                    </FormDescription>
                    <FormControl>
                      <Input
                        type="number"
        ...
        <CardFooter>
          <Button
            type="submit"
            onClick={createPersonaForm.handleSubmit(onSubmit)}
            className="w-full sm:w-auto"
          >
            {isCreateLoading ? (
              "Creating Persona..."
