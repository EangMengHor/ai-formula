...
export default function Workshop() {
  ...
  const navCards = [
    ...
    },
    {
      ...
      description:
        "Create and simulate social media posts and analyze the social media environment",
    },
    {
      id: 4,
    ...
    <main className="min-h-screen bg-black text-white">
      <div className="max-w-7xl mx-auto px-4 py-16 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h2 className="text-2xl font-light text-center mb-10 text-gray-400">
            Utilize Comprehensive ARX Tools ?
          </h2>
