          ...
          {sidebarStack &&
            ...
            sidebarStack.map((item, index) => (
              <Sheet
                key={index}
                className="w-full"
                open={!removedSheetIndex.includes(index)}
                onOpenChange={() => {
                  setRemovedSheetIndex((prev) => [...prev, index]);
                  setTimeout(() => {
                    setRemovedSheetIndex((prev) =>
              ...
              >
                <SheetContent
                  className="w-[80%] overflow-y-scroll bg-slate-800"
                  style={{
                ...
                >
                  <SheetHeader>
                    ...
                    {item.component ? (
                      ...
                      <SheetDescription>No Content</SheetDescription>
                    )}
                  </SheetHeader>
                </SheetContent>
              </Sheet>
