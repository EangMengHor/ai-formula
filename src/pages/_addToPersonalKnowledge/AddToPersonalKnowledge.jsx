        ...
        <div className="p-4">
            <div className="mb-8">
                ...
                <p className="text-slate-300 max-w-2xl">
                    Please upload your internal knowledge documents here. <span className="font-semibold text-white">Arx</span> and its agents will securely process and learn from your files, empowering you with smarter, more personalized assistance.
                </p>
            </div>
            ...
            {files.length === 0 ? (
                    ...
                    <div className="w-full max-w-4xl h-[60vh] flex flex-col items-center justify-center border-2 border-dashed border-slate-600 rounded-lg bg-[#181e29] p-8">
                        ...
                        <div className="mt-6 text-center">
                            <p className="text-slate-400">
                                Start by uploading your first document.<br />
                                <span className="text-white font-medium">Arx</span> will handle the rest!
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <>
                    ...
                    <div className="rounded-md">
                        <h2 className="text-lg font-semibold text-white mb-4">Your Uploaded Documents</h2>
                        <Table>
                            <TableHeader>
                        ...
                        <div className="mt-4 text-slate-400 text-sm">
                            <span className="font-semibold text-white">Arx</span> and its agents will automatically process your documents and make them available for smarter, context-aware assistance.
                        </div>
                    </div>
                </>
            )}
