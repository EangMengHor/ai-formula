...
export default function UserFormProgress() {
    ...
    const [selectedSocialPlatform, setSelectedSocialPlatform] = useState("reddit"); // or twitter
    const [isSocialPlatformSelected, setIsSocialPlatmformSelecte] = useState(false)
                    ...
                    <div className="w-full h-full flex items-center justify-center">
                        <div className="flex flex-col gap-2 items-center justify-center h-[60%] w-[70%]">
                            ...
                            <div className="text-center text-white mb-10">
                                <h3 className="font-semibold text-2xl">Choose a Social Media Platform to Create User Templates</h3>
                                <p className="capitalize">User templates help you create groups of users for your social media simulations</p>
                            </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-2 w-full h-full">
                                {
                                    socialPlatform.map(platform => (
                                        ...
                                        >
                                            ...
                                            {/* description */}
                                            <div className="w-[50%]">
                                                <p className={`text-center ${platform.hoverColor == "red" ? "text-slate-300" : "text-slate-200"}`}>Create {platform.name} Users For Reddit Simulation</p>
                                            </div>
                ...
                demographics.map((item, index) => {
                    ...
                    return (
                        <div key={index} className="w-full h-full flex flex-col gap-2 mt-4">
                            <h3 className="text-lg font-semibold text-white">{item.fieldName}</h3>
                            <RatioSlider
