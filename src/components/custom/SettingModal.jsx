                            ...
                            {menuItems.map((item) => (
                                <li key={item}>
                                    <button
                                        ...
                                        className={`w-full text-left px-3 py-2 rounded transition ${selectedTab === item ? "bg-slate-600" : "hover:bg-slate-900"
                                            }`}
                                    >
                                        {item}
                                    </button>
                    ...
                    <div className="w-3/4 p-6 space-y-6 overflow-y-auto">
                        ...
                        {selectedTab === "Personal knowledge" && (
                            <>
                                ...
                                <div className="flex justify-between items-center">
                                    <Label>ARX Use Your Personal Profile Knowledge {userPersonalKnowledgeStatus ? "(Currently On)" : "(Currently Off)"}</Label>
                                    <Switch
                        ...
                        {selectedTab === "My Profile" &&
                            ...
                            <div className="space-y-4">
                                ...
                                <PortfolioCard
                                    data={userPersonalProfile}
                                />
                            </div>
                        ) : (
                            selectedTab === "My Profile" && (
                                <div>No Data Right Now. </div>
                            )
                        )
                        }
