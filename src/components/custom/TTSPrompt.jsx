...
const TTSPrompt = forwardRef(
  (
    { startButton, loadingButton, StopButton, prompt = "", onComplete },
    ref,
  ) => {
    ...
    const startTTS = async (overrideText = null) => {
      ...
      // If a React event is passed (e.g. from onClick), ignore it and use state text
      if (
      ...
      if (
        ...
        console.warn(
          "TTSPrompt: No valid text to speak or using default error text:",
          safeText,
        );
        return;
      }
      ...
      console.log(
        "🔊 TTSPrompt starting TTS with text:",
          ...
          try {
            ...
            while (shouldContinueRef.current) {
              ...
              if (
                ...
                sourceBuffer.buffered.end(0) - sourceBuffer.buffered.start(0) >
                  1
              ) {
