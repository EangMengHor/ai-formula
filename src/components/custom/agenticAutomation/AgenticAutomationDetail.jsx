      ...
      <div className="border-b border-slate-800/60">
        <div className="max-w-[1400px] mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-2">
            <h2 className="text-lg font-medium text-white truncate max-w-[200px] sm:max-w-xs md:max-w-md">
              {name}
            </h2>
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-3">
                    <AnimatePresence initial={false}>
                      {superiorPersonas
                        .slice(0, expanded ? superiorPersonas.length : 3)
                        .map((persona, index) => (
                          <motion.div
                            key={`persona-${index}`}
        ...
        <DialogContent className="bg-slate-900 border-slate-700 text-slate-100 max-w-2xl">
          <DialogHeader>
            ...
            <DialogDescription className="text-slate-400 pt-2">
              Running this workflow now will not change the next scheduled run
              time as it's already queued.
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="space-y-3 py-2">
            <div className="flex items-start gap-2">
              ...
              <p className="text-sm text-slate-300">
                The last run time will be updated to the current time.
              </p>
            </div>
            ...
            <div className="flex items-start gap-2">
              ...
              <p className="text-sm text-slate-300">
                Logs and changes will appear in your dashboard after
