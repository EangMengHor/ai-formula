...
const GroupSuperiorPersonaSection = ({
  onFetchSuperiorPersona,
  isShowInteractionOptions = true,
}) => {
  const {
    ...
    <div className="p-3">
              ...
              return (
                ...
                >
                  ...
                  <CardHeader className="p-2">
                    <CardTitle className="font-semibold text-xl text-white">
                      {item.label}
                    </CardTitle>
      ...
      <div className="overflow-y-scroll">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2 mt-2 overflow-y-scroll">
          {SupPerItems &&
            SupPerItems.length > 0 &&
            [...SupPerItems].reverse().map((item, index) => {
              ...
              return (
                ...
                >
                  <div>
                    <p className="text-ellipsis line-clamp-2 text-white w-[90%]">
                      {item.title}
                    </p>
