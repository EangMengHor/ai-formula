import { Brain, BriefcaseBusiness, Goal, Hand, HeartHandshake } from "lucide-react";
...
export default function PersonaOp({
    ...
    function handleDetails() {
        setSidebarStack((prev) => [...prev, {
            component: <PersonaDetails output={output} title={title} goal={goal} team={team} cot={cot} />
        }])
    }
            ...
            <div>
                <div className="flex gap-2 items-center">
                    ...
                    </div>
                    {
                        cot.length > 0 && (
                            <div
                                className="flex gap-2 bg-purple-700 px-3 py-1 rounded-md items-center">
                            ...
                            <TooltipProvider key={item} delayDuration={10}>
                                <Tooltip>
                                    <TooltipTrigger asChild>
                                        <div
                                            className="bg-slate-800 w-fit border border-slate-600/50 px-3 py-2 rounded-md flex gap-2 items-center text-white transition-colors cursor-pointer"
                                        >
