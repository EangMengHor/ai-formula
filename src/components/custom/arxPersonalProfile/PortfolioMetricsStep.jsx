    ...
    <div className="flex">
      <div key="form" className="space-y-6">
        <div>
          ...
          <p className="text-gray-400">
            Adjust these metrics to reflect your portfolio's risk
        ...
        <div className="mt-8 space-y-6">
          <div className="space-y-2">
            ...
            <div className="relative">
              <Slider
                ...
                step={0.5}
                onValueChange={(value) =>
                  handlePortfolioMetricsChange("var", value)
                }
              ...
              <div className="absolute inset-0 pointer-events-none">
                <div
                  ...
                  style={{
                    left: `calc(${(formData.portfolioMetrics.var / 30) * 100}% - 8px)`,
                  }}
                ></div>
              </div>
            </div>
          ...
          <div className="space-y-2">
            <div className="flex justify-between">
              ...
              <span className="text-sm font-medium text-gray-300">
                {formData.portfolioMetrics.cvar}%
              </span>
            </div>
            <div className="relative">
              <Slider
                ...
                step={0.5}
                onValueChange={(value) =>
                  handlePortfolioMetricsChange("cvar", value)
                }
                className="[&>span]:bg-blue-600"
              />
              <div className="absolute inset-0 pointer-events-none">
                <div
                  className="absolute top-1/2 transform -translate-y-1/2 w-4 h-4 bg-white rounded-full border-2 border-blue-600"
                  style={{
                    left: `calc(${(formData.portfolioMetrics.cvar / 40) * 100}% - 8px)`,
                  }}
                ></div>
              </div>
            </div>
          ...
          <div className="space-y-2">
            <div className="flex justify-between">
              ...
              <span className="text-sm font-medium text-gray-300">
                {formData.portfolioMetrics.maxDrawdown}%
              </span>
            </div>
            <div className="relative">
              <Slider
                ...
                step={1}
                onValueChange={(value) =>
                  handlePortfolioMetricsChange("maxDrawdown", value)
                }
                className="[&>span]:bg-blue-600"
              />
              <div className="absolute inset-0 pointer-events-none">
                <div
                  className="absolute top-1/2 transform -translate-y-1/2 w-4 h-4 bg-white rounded-full border-2 border-blue-600"
                  style={{
                    left: `calc(${(formData.portfolioMetrics.maxDrawdown / 50) * 100}% - 8px)`,
                  }}
                ></div>
              </div>
            </div>
          ...
          <div className="space-y-2">
            <div className="flex justify-between">
              ...
              <span className="text-sm font-medium text-gray-300">
                {formData.portfolioMetrics.esgWeightedBeta}
              </span>
            </div>
            <div className="relative">
              <Slider
                ...
                step={0.05}
                onValueChange={(value) =>
                  handlePortfolioMetricsChange("esgWeightedBeta", value)
                }
                className="[&>span]:bg-blue-600"
              />
              <div className="absolute inset-0 pointer-events-none">
                <div
                  className="absolute top-1/2 transform -translate-y-1/2 w-4 h-4 bg-white rounded-full border-2 border-blue-600"
                  style={{
                    left: `calc(${(formData.portfolioMetrics.esgWeightedBeta / 2) * 100}% - 8px)`,
                  }}
                ></div>
              </div>
            </div>
            <p className="text-xs text-gray-500">
              Market sensitivity adjusted for ESG factors
            </p>
          </div>
        </div>
        ...
        <div className="mt-8">
          <p className="text-blue-400 text-sm">
            "AI will use these risk metrics to ensure your portfolio stays
            within your risk tolerance while maximizing returns."
          </p>
        </div>
      </div>
      ...
      >
              ...
              <div className="absolute top-0 left-0 w-full h-full flex items-center justify-center">
                <div className="relative w-32 h-32">
                  ...
                  <svg viewBox="0 0 100 50" className="w-full">
                    ...
                    {/* High risk segment */}
                    <path
                      d="M 66,50 A 50,50 0 0,1 100,50"
                      fill="none"
                      stroke="#EF4444"
                      strokeWidth="10"
                    />
        ...
        <p className="mt-6 text-gray-400 text-center max-w-xs">
          Risk metrics help AI balance potential returns with your risk
          tolerance
        </p>
      </div>
    </div>
