...
export default function ConstraintsStep({ formData, setFormData }) {
    ...
    if (newConstraint.trim()) {
      setFormData({
        ...
        crossBorderConstraints: [
          ...formData.crossBorderConstraints,
          { text: newConstraint.trim(), id: Date.now() },
        ],
      });
      setNewConstraint("");
    }
  ...
  const removeConstraint = (id) => {
    setFormData({
      ...formData,
      crossBorderConstraints: formData.crossBorderConstraints.filter(
      ...
      <div key="form" className="space-y-6">
        <div>
          ...
          <p className="text-gray-400">
            Define the constraints that should guide your investment strategy.
          </p>
        </div>
        ...
        <div className="mt-8 space-y-6">
          <div className="space-y-2">
            <div className="flex justify-between">
              ...
              <span className="text-sm font-medium text-gray-300">
                {formData.constraints.liquidity}%
              </span>
            </div>
            <div className="relative">
              <Slider
                ...
                step={5}
                onValueChange={(value) =>
                  handleConstraintChange("liquidity", value)
                }
              ...
              <div className="absolute inset-0 pointer-events-none">
                <div
                  ...
                  style={{
                    left: `calc(${formData.constraints.liquidity}% - 8px)`,
                  }}
                ></div>
              </div>
            </div>
            <p className="text-xs text-gray-500">
              Percentage of portfolio that must be liquid
            </p>
          </div>
          ...
          <div className="space-y-2">
            <div className="flex justify-between">
              ...
              <span className="text-sm font-medium text-gray-300">
                {formData.constraints.drawdownCeilings}%
              </span>
            </div>
            <div className="relative">
              <Slider
                ...
                step={1}
                onValueChange={(value) =>
                  handleConstraintChange("drawdownCeilings", value)
                }
                className="[&>span]:bg-blue-600"
              />
              <div className="absolute inset-0 pointer-events-none">
                <div
                  className="absolute top-1/2 transform -translate-y-1/2 w-4 h-4 bg-white rounded-full border-2 border-blue-600"
                  style={{
                    left: `calc(${(formData.constraints.drawdownCeilings / 50) * 100}% - 8px)`,
                  }}
                ></div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  placeholder="e.g., 5%"
                  value={
                    formData.constraints.exposureLimits.singleSecurity || ""
                  }
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  placeholder="e.g., 30%"
                  value={
                    formData.constraints.exposureLimits.internationalMarkets ||
                    ""
                  }
                  onChange={handleExposureLimitChange}
                  className="bg-[#2a3042] border-gray-700 text-white"
              ...
              <div className="space-y-2">
                <Label
                  htmlFor="alternativeInvestments"
                  className="text-gray-400 text-sm"
                >
        ...
        <div className="mt-8">
          <p className="text-blue-400 text-sm">
            "AI will respect these constraints when optimizing your portfolio to
            ensure compliance with your requirements and risk tolerance."
          </p>
        </div>
      </div>
            ...
            <div>
              ...
              <div className="w-full bg-gray-700 h-2 rounded-full">
                <div
                  ...
                  style={{
                    width: `${(formData.constraints.drawdownCeilings / 50) * 100}%`,
                  }}
                ></div>
              </div>
            </div>
                ...
                {Object.entries(formData.constraints.exposureLimits).map(
                  ([key, value]) =>
                    value && (
                      <div
                        key={key}
                        className="bg-gray-700/50 rounded p-2 flex justify-between"
                      >
          ...
          <div className="mt-4 pt-4 border-t border-gray-700">
            <div className="flex justify-between text-sm">
              ...
              <span className="text-white font-medium">
                {formData.crossBorderConstraints.length} constraints
              </span>
            </div>
          </div>
        </div>
        <p className="mt-6 text-gray-400 text-center max-w-xs">
          Investment constraints help AI build a portfolio that meets your
