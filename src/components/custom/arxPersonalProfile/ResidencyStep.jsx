    ...
    <div className="flex gap-4 w-full justify-between">
      <div key="form" className="space-y-6">
        <div>
          ...
          <p className="text-gray-400">
            Your geographic location helps us understand relevant tax and
        ...
        <div className="mt-8">
          <p className="text-blue-400 text-sm">
            "AI will use your location to identify jurisdiction-specific
            investment opportunities and tax optimization strategies."
          </p>
        </div>
      </div>
      ...
      >
        ...
        <p className="mt-6 text-gray-200 text-center max-w-xs">
          Location data helps AI recommend tax-efficient investment strategies
