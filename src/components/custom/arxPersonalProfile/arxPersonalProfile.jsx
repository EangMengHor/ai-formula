...
export default function PersonalProfileForm() {
  ...
  const submitToApi = useCallback(async () => {
    ...
    try {
      const response = await fetch("https://your-api-endpoint.com/investor-profile", {
        method: "POST",
        headers: {
  ...
  const steps = [
    {
      component: [
        <NameStep key="nameStep" formData={formData} setFormData={setFormData} />,
    ...
    {
      component: [
        <EntityStep key="entityStep" formData={formData} setFormData={setFormData} />,
    ...
    {
      component: [
        <ResidencyStep key="residencyStep" formData={formData} setFormData={setFormData} />,
    ...
    {
      component: [
        <JurisdictionsStep key="jurisdictionsStep" formData={formData} setFormData={setFormData} />,
    ...
    {
      component: [
        <AssetClassStep key="assetClassStep" formData={formData} setFormData={setFormData} />,
    ...
    {
      component: [
        <EsgPreferencesStep key="esgPreferencesStep" formData={formData} setFormData={setFormData} />,
        <div key="esgPreferencesVisualization">ESG Preferences Visualization</div>,
      ],
      canProceed: true,
    },
    {
      component: [
        <RiskToleranceStep key="riskToleranceStep" formData={formData} setFormData={setFormData} />,
        <div key="riskToleranceVisualization">Risk Tolerance Visualization</div>,
      ],
      canProceed: formData.riskTolerance !== "",
    },
    {
      component: [
        <LiquidityStep key="liquidityStep" formData={formData} setFormData={setFormData} />,
    ...
    {
      component: [
        <SecurityStep key="securityStep" formData={formData} setFormData={setFormData} />,
    ...
    {
      component: [
        <PositionMetricsStep key="positionMetricsStep" formData={formData} setFormData={setFormData} />,
        <div key="positionMetricsVisualization">Position Metrics Visualization</div>,
      ],
      canProceed: true,
    },
    {
      component: [
        <PortfolioMetricsStep key="portfolioMetricsStep" formData={formData} setFormData={setFormData} />,
        <div key="portfolioMetricsVisualization">Portfolio Metrics Visualization</div>,
      ],
      canProceed: true,
    },
    {
      component: [
        <TransactionStep key="transactionStep" formData={formData} setFormData={setFormData} />,
    ...
    {
      component: [
        <AllocationStep key="allocationStep" formData={formData} setFormData={setFormData} />,
    ...
    {
      component: [
        <ComplianceStep key="complianceStep" formData={formData} setFormData={setFormData} />,
    ...
    {
      component: [
        <TaxStrategiesStep key="taxStrategiesStep" formData={formData} setFormData={setFormData} />,
        <div key="taxStrategiesVisualization">Tax Strategies Visualization</div>,
      ],
      canProceed: true,
    },
    {
      component: [
        <ConstraintsStep key="constraintsStep" formData={formData} setFormData={setFormData} />,
    ...
    {
      component: [
        <GoalsStep key="goalsStep" formData={formData} setFormData={setFormData} />,
  ...
  return (
    <div className="min-h-screen bg-[#1a1f2c] text-white flex flex-col">
      <div className="w-full px-4 py-2">
        <Progress value={calculateProgress()} className="h-1 bg-gray-700" indicatorClassName="bg-blue-500" />
      </div>
      ...
      <div className="flex-1 flex flex-col md:flex-row">
        ...
        <div className="w-full md:w-1/2 p-6 md:p-12 flex flex-col justify-center">
          ...
          <div className="flex justify-between mt-8">
            ...
            {currentStep < steps.length - 1 ? (
              ...
              <Button type="button" className="bg-green-600 hover:bg-green-700 text-white" onClick={submitToApi}>
                Submit Profile
              </Button>
            )}
          </div>
        ...
        <div className="w-full md:w-1/2 bg-blue-600 p-6 md:p-12 flex items-center justify-center">
          <AnimatePresence mode="wait">
            <motion.div
            ...
            >
              {Array.isArray(steps[currentStep].component) ? steps[currentStep].component[1] : null}
            </motion.div>
          </AnimatePresence>
        </div>
      </div>
