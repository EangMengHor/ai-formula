    ...
    <div className="flex gap-4 w-full justify-between">
      <div key="form" className="space-y-6 ">
        <div>
          ...
          <p className="text-gray-400">
            If you're investing on behalf of a company, family office, or other
            entity, let us know.
          </p>
        </div>
        ...
        <div className="mt-8">
          <p className="text-blue-400 text-sm">
            "AI can analyze entity-specific investment patterns and regulatory
            requirements to optimize your portfolio strategy."
          </p>
        </div>
      </div>
      ...
      >
        ...
        <p className="mt-6 text-gray-200 text-center max-w-xs">
          Entity information helps AI tailor recommendations for organizational
          investment goals
        </p>
      </div>
    </div>
