...
export default function ComplianceStep({ formData, setFormData }) {
    ...
    if (newExposure.jurisdiction && newExposure.exposurePercentage) {
      setFormData({
        ...
        jurisdictionalExposure: [
          ...formData.jurisdictionalExposure,
          { ...newExposure, id: Date.now() },
        ],
      });
      setNewExposure({
        jurisdiction: "",
  ...
  const removeExposure = (id) => {
    setFormData({
      ...formData,
      jurisdictionalExposure: formData.jurisdictionalExposure.filter(
  ...
  return (
    <div className="flex">
      <div key="form" className="space-y-6">
        <div>
          ...
          <p className="text-gray-400">
            Enter your exposure to different jurisdictions for compliance
            purposes (optional).
          </p>
        </div>
        ...
        <div className="mt-8 space-y-4">
          ...
          <div className="grid grid-cols-3 gap-2">
            ...
            <Button
              ...
              onClick={addExposure}
              disabled={
                !newExposure.jurisdiction || !newExposure.exposurePercentage
              }
        ...
        <div className="mt-8">
          <p className="text-blue-400 text-sm">
            "AI will analyze your jurisdictional exposure to identify potential
            regulatory issues and tax optimization opportunities across
            borders."
          </p>
        </div>
      </div>
      ...
      <div
        key="visual"
        className="flex flex-col items-center w-1/2 justify-center h-full"
      >
                    ...
                    <div className="flex items-center">
                      <div className="w-24 h-2 bg-gray-700 rounded-full mr-2">
                        <div
                          ...
                          style={{
                            width: `${Math.min(exposure.exposurePercentage, 100)}%`,
                          }}
                        ></div>
                      </div>
              ...
              <div className="mt-4 pt-4 border-t border-gray-700">
                <div className="flex justify-between text-sm">
                  ...
                  <span className="text-white font-medium">
                    {formData.jurisdictionalExposure.length}
                  </span>
                </div>
              </div>
            </div>
        ...
        <p className="mt-6 text-gray-400 text-center max-w-xs">
          Jurisdictional exposure helps AI identify regulatory requirements and
          tax implications
        </p>
      </div>
    </div>
