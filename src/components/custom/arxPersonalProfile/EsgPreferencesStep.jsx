    ...
    <div className="flex">
      <div key="form" className="space-y-6">
        <div>
          ...
          <p className="text-gray-400">
            Select any environmental, social, or governance factors important to
            you.
          </p>
        </div>
        ...
        <div className="mt-8">
          <p className="text-blue-400 text-sm">
            "AI will incorporate your ESG preferences to align your investments
            with your values while maintaining performance objectives."
          </p>
        </div>
      </div>
      ...
      >
              ...
              <div className="grid grid-cols-2 gap-3">
                {formData.esgPreferences.map((prefId) => {
                  ...
                  return (
                    <div
                      key={prefId}
                      className="bg-blue-600/20 rounded-lg p-3 flex items-center"
                    >
                      {pref?.icon}
              ...
              <div className="mt-4 pt-4 border-t border-gray-700">
                <div className="flex justify-between text-sm">
                  ...
                  <span className="text-white font-medium">
                    {formData.esgPreferences.length > 4
                      ? "High"
                      : formData.esgPreferences.length > 2
                        ? "Medium"
                        : "Low"}
                  </span>
                </div>
        ...
        <p className="mt-6 text-gray-400 text-center max-w-xs">
          Your ESG preferences help AI find investments that align with your
          values
        </p>
      </div>
    </div>
