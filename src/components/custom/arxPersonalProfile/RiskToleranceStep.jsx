            ...
            <div key="form" className="space-y-6">
                    ...
                    <div className="space-y-3 mt-2">
                        {riskOptions.map((option) => (
                            <Button
                                ...
                                type="button"
                                variant="outline"
                                className={`w-full justify-start text-left py-10 ${formData.riskTolerance === option.value
                ...
                <div className="mt-8">
                    <p className="text-blue-400 text-sm">
                        "AI will use your risk tolerance to balance potential returns with volatility, creating a portfolio that helps
                        you sleep at night."
                    </p>
                </div>
            </div>
                        ...
                        <div className="w-full h-full flex flex-col items-center justify-center">
                            {formData.riskTolerance === "conservative" && (
                                <>
                                    ...
                                    <div className="text-center">
                                        <div className="text-xl font-bold text-white mb-2">Conservative</div>
                                        <div className="flex items-center justify-center space-x-1">
                                            <div className="h-1 w-8 bg-blue-500 rounded-full"></div>
                                            <div className="h-1 w-8 bg-gray-600 rounded-full"></div>
                                            <div className="h-1 w-8 bg-gray-600 rounded-full"></div>
                                        </div>
                                        <div className="mt-4 text-sm text-gray-400">Lower risk, stable returns</div>
                                    </div>
                                </>
                            )}
                            ...
                            {formData.riskTolerance === "moderate" && (
                                <>
                                    ...
                                    <div className="text-center">
                                        <div className="text-xl font-bold text-white mb-2">Moderate</div>
                                        <div className="flex items-center justify-center space-x-1">
                                            <div className="h-1 w-8 bg-blue-500 rounded-full"></div>
                                            <div className="h-1 w-8 bg-green-500 rounded-full"></div>
                                            <div className="h-1 w-8 bg-gray-600 rounded-full"></div>
                                        </div>
                                        <div className="mt-4 text-sm text-gray-400">Balanced risk and return</div>
                                    </div>
                                </>
                            )}
                            ...
                            {formData.riskTolerance === "aggressive" && (
                                <>
                                    ...
                                    <div className="text-center">
                                        <div className="text-xl font-bold text-white mb-2">Aggressive</div>
                                        <div className="flex items-center justify-center space-x-1">
                                            <div className="h-1 w-8 bg-blue-500 rounded-full"></div>
                                            <div className="h-1 w-8 bg-green-500 rounded-full"></div>
                                            <div className="h-1 w-8 bg-green-500 rounded-full"></div>
                                        </div>
                                        <div className="mt-4 text-sm text-gray-400">Higher risk, growth potential</div>
                                    </div>
                                </>
                            )}
                        </div>
