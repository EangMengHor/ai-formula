      ...
      <div key="form" className="space-y-6">
        <div>
          ...
          <p className="text-gray-400">
            Enter metrics that describe the performance characteristics of your
            positions (optional).
          </p>
        </div>
        ...
        <div className="mt-8 space-y-6">
          <div className="space-y-2">
            ...
            <p className="text-xs text-gray-500">
              The percentage gain or loss on investments that haven't been sold
              yet
            </p>
          </div>
          ...
          <div className="space-y-2">
            ...
            />
            <p className="text-xs text-gray-500">
              Measures volatility relative to the market (1.0 = same as market,
              &gt;1 = more volatile)
            </p>
          </div>
          ...
          <div className="space-y-2">
            ...
            />
            <p className="text-xs text-gray-500">
              Risk-adjusted return metric (higher is better, &gt;1 is good,
              &gt;2 is excellent)
            </p>
          </div>
          ...
          <div className="space-y-2">
            ...
            />
            <p className="text-xs text-gray-500">
              Similar to Sharpe but only penalizes downside volatility (higher
              is better)
            </p>
          </div>
        </div>
        ...
        <div className="mt-8">
          <p className="text-blue-400 text-sm">
            "AI will use these metrics to evaluate the risk-adjusted performance
            of your positions and identify opportunities for optimization."
          </p>
        </div>
      </div>
          ...
          formData.positionMetrics.sortinoRatio > 0 ? (
            <div className="space-y-4">
              ...
              <div>
                <div className="flex justify-between text-sm mb-1">
                  ...
                  <span className="text-white">
                    {formData.positionMetrics.beta.toFixed(2)}
                  </span>
                </div>
                <div className="w-full bg-gray-700 h-2 rounded-full">
                  <div
                    ...
                    style={{
                      width: `${Math.min(formData.positionMetrics.beta * 50, 100)}%`,
                    }}
                  ></div>
                </div>
              </div>
              ...
              <div>
                <div className="flex justify-between text-sm mb-1">
                  ...
                  <span className="text-white">
                    {formData.positionMetrics.sharpeRatio.toFixed(2)}
                  </span>
                </div>
                <div className="w-full bg-gray-700 h-2 rounded-full">
                  <div
                    ...
                    style={{
                      width: `${Math.min(formData.positionMetrics.sharpeRatio * 33, 100)}%`,
                    }}
                  ></div>
                </div>
              </div>
              ...
              <div>
                <div className="flex justify-between text-sm mb-1">
                  ...
                  <span className="text-white">
                    {formData.positionMetrics.sortinoRatio.toFixed(2)}
                  </span>
                </div>
                <div className="w-full bg-gray-700 h-2 rounded-full">
                  <div
                    ...
                    style={{
                      width: `${Math.min(formData.positionMetrics.sortinoRatio * 33, 100)}%`,
                    }}
                  ></div>
                </div>
              </div>
            ...
            <div className="text-gray-500 text-center py-8">
              ...
              <div className="text-sm mt-2">
                to see performance visualization
              </div>
            </div>
          )}
        </div>
        <p className="mt-6 text-gray-400 text-center max-w-xs">
          Position metrics help AI evaluate risk-adjusted performance of your
          investments
        </p>
      </div>
    </div>
