        ...
        <div>
            <Dialog>
                <DialogTrigger>
                    ...
                    {
                        Object.keys(interactionData).length > 0 && <div>
                            <p className="text-left my-2">{interactionData && interactionData.hasOwnProperty('other') && interactionData.other.length} Step Interaction</p>
                            <Button className="bg-slate-700 text-white">View Interaction Logs</Button>
